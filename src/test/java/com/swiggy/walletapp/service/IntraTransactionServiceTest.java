...
//        transactionService = new TransactionService(userRepository, walletRepository, intraTransactionRepository);
//    }
//
//    @Test
...
//        IntraTransaction intraTransaction = new IntraTransaction(wallet.convertedAmount(Currency.INR, 100.0), TransactionType.DEPOSIT, userId);
//
//        when(userRepository.findById(userId)).thenReturn(Optional.of(user));
//        when(walletRepository.findById(walletId)).thenReturn(Optional.of(wallet));
//
...
//        verify(intraTransactionRepository).save(intraTransaction);
//    }
//
//    @Test
...
//        Wallet wallet = new Wallet(1000.0, user, Currency.INR);
//        TransactionDto transactionDto = new TransactionDto(TransactionType.DEPOSIT, 100.0, Currency.USD);
//        IntraTransaction intraTransaction = new IntraTransaction(wallet.convertedAmount(Currency.USD, 100.0), TransactionType.DEPOSIT, userId);
//
//        when(userRepository.findById(userId)).thenReturn(Optional.of(user));
//        when(walletRepository.findById(walletId)).thenReturn(Optional.of(wallet));
//
...
//        IntraTransaction intraTransaction = new IntraTransaction(wallet.convertedAmount(Currency.EUR, 100.0), TransactionType.DEPOSIT, userId);
//
//        when(userRepository.findById(userId)).thenReturn(Optional.of(user));
//        when(walletRepository.findById(walletId)).thenReturn(Optional.of(wallet));
//
...
//        User user = new User("username", "password");
//        Wallet wallet = new Wallet(user, Currency.INR);
//        TransactionDto transactionDto = new TransactionDto(TransactionType.WITHDRAWAL, 0.0, Currency.USD);
//
//        when(userRepository.findById(userId)).thenReturn(Optional.of(user));
//        when(walletRepository.findById(walletId)).thenReturn(Optional.of(wallet));
//
...
//        User user = new User("username", "password");
//        Wallet wallet = new Wallet(user, Currency.INR);
//        TransactionDto transactionDto = new TransactionDto(TransactionType.WITHDRAWAL, -100.0, Currency.USD);
//
//        when(userRepository.findById(userId)).thenReturn(Optional.of(user));
//        when(walletRepository.findById(walletId)).thenReturn(Optional.of(wallet));
//
...
//        User user = new User("username", "password");
//        Wallet wallet = new Wallet(1000.0, user, Currency.INR);
//        TransactionDto transactionDto = new TransactionDto(TransactionType.WITHDRAWAL, 10.0, Currency.INR);
//        IntraTransaction intraTransaction = new IntraTransaction(wallet.convertedAmount(Currency.INR, 10.0), TransactionType.WITHDRAWAL, userId);
//
//        when(userRepository.findById(userId)).thenReturn(Optional.of(user));
//        when(walletRepository.findById(walletId)).thenReturn(Optional.of(wallet));
//
...
//        User user = new User("username", "password");
//        Wallet wallet = new Wallet(1000.0, user, Currency.INR);
//        TransactionDto transactionDto = new TransactionDto(TransactionType.WITHDRAWAL, 10.0, Currency.USD);
//        IntraTransaction intraTransaction = new IntraTransaction(wallet.convertedAmount(Currency.USD, 10.0), TransactionType.WITHDRAWAL, userId);
//
//        when(userRepository.findById(userId)).thenReturn(Optional.of(user));
//        when(walletRepository.findById(walletId)).thenReturn(Optional.of(wallet));
//
...
//        User user = new User("username", "password");
//        Wallet wallet = new Wallet(1000.0, user, Currency.INR);
//        TransactionDto transactionDto = new TransactionDto(TransactionType.WITHDRAWAL, 10.0, Currency.EUR);
//        IntraTransaction intraTransaction = new IntraTransaction(wallet.convertedAmount(Currency.EUR, 10.0), TransactionType.WITHDRAWAL, userId);
//
//        when(userRepository.findById(userId)).thenReturn(Optional.of(user));
//        when(walletRepository.findById(walletId)).thenReturn(Optional.of(wallet));
//
...
//        User user = new User("username", "password");
//        Wallet wallet = new Wallet(user, Currency.INR);
//        IntraTransaction firstIntraTransaction = new IntraTransaction(1L, 100.0, TransactionType.DEPOSIT, userId);
//        IntraTransaction secondIntraTransaction = new IntraTransaction(2L, 50.0, TransactionType.WITHDRAWAL, userId);
//        List<IntraTransaction> intraTransactionList = List.of(firstIntraTransaction, secondIntraTransaction);
//        List<TransactionResponseDto> transactionResponseDtoList = List.of(
//                new TransactionResponseDto(1L, 100.0, TransactionType.DEPOSIT, userId),
//                new TransactionResponseDto(2L, 50.0, TransactionType.WITHDRAWAL, userId)
//        );
//
//        when(userRepository.findById(userId)).thenReturn(Optional.of(user));
//        when(walletRepository.findById(walletId)).thenReturn(Optional.of(wallet));
//        when(intraTransactionRepository.findByUserId(userId)).thenReturn(intraTransactionList);
//        when(transactionMapper.toDtoList(intraTransactionList)).thenReturn(transactionResponseDtoList);
//
//        List<TransactionResponseDto> result = transactionService.getTransactions(userId, walletId);
//
